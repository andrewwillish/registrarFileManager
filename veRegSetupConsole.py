...
class ramSetupConsole:
    ...
    def setupSequenceRoot(self):
        ...
        if pathVar=='':
            print ('path is empty')
        veRegSetupCore.setRootPath(sequencialRootPath=pathVar)
    ...
    def setupAssetRoot(self):
        ...
        if pathVar=='':
            print ('path is empty')
        veRegSetupCore.setRootPath(assetRootPath=pathVar)
        print ('RAM asset root set')
        return

    def setupFun(self):
        veRegSetupCore.setupAssetTable()
        veRegSetupCore.setupLogTable()
        veRegSetupCore.setupRootXml()
        veRegSetupCore.setupAssetNotes()
